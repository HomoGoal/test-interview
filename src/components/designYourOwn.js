...
const DesignYOurOwn=()=>{
    return(
        <div className="designYourOwn">
            <p>DESIGN YOUR OWN</p>
            <h1>Play With Your Style</h1>
            <div className="designItemGroup">
                <div>
                    <div>
                    ...
                    <p>KeriKit Lennox Black Crossover Leather </p>
                    <button>GO DESIGN</button>
                </div>
                <div>
                <div>
                    ...
                    <p>Paul Poppy The Ravenscourt  </p>
                    <button>GO DESIGN</button>
                </div>
                <div>
                <div>
                    ...
                    <p>KeriKit Lennox Crossover Leather  </p>
                    <button>GO DESIGN</button>
                </div>
            </div>
            <button className="buttonAll">ALL BAGS</button>
        </div>
    )
}
